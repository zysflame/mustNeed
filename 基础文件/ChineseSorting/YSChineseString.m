...
#import "YSChineseString.h"

@implementation YSChineseString
@synthesize string;
@synthesize pinYin;
...
+(NSMutableArray*)IndexArray:(NSArray*)stringArr
{
    ...
    {
        NSString *pinyin = [((YSChineseString*)object).pinYin substringToIndex:1];
        //不同
...
+(NSMutableArray*)LetterSortArray:(NSArray*)stringArr
{
    ...
    for (NSString* object in tempArray) {
        ...
        NSString *pinyin = [((YSChineseString*)object).pinYin substringToIndex:1];
        NSString *string = ((YSChineseString*)object).string;
        //不同
        if(![tempString isEqualToString:pinyin])
        {
            //分组
...
+(NSMutableArray*)ReturnSortChineseArrar:(NSArray*)stringArr
{
    ...
    {
        YSChineseString *chineseString = [[YSChineseString alloc]init];
        ...
        chineseString.string = [YSChineseString RemoveSpecialCharacter:chineseString.string];
...
//        NSLog(@"chineseStringsArray====%@",((YSChineseString*)[chineseStringsArray objectAtIndex:i]).string);
//    }
//    NSLog(@"-----------------------------");
...
+(NSMutableArray*)SortArray:(NSArray*)stringArr
{
    ...
    for(int i=0;i<[stringArr count];i++){
        [result addObject:((YSChineseString*)[tempArray objectAtIndex:i]).string];
        NSLog(@"SortArray----->%@",((YSChineseString*)[tempArray objectAtIndex:i]).string);
    }
    return result;
}
